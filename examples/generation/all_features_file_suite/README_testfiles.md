...
`mc` `-` `5m_1fo_1fp` `-` `8c_2f_16s_2el_2mw_2ew` `-` `1mez_1fo` `-` `1cez` `-` `sc`

- First section: chip size
- Second section: Channels
- Third section: dynamic module exclusion zones
- Fourth section: static chip exclusion zones
- Fifth section: flag for soft corners property (no sharp angled routing)
