...
import {DynamicRoutingExclusion, StaticRoutingExclusion} from "../routingExclusion";
...
export function encodeChannelPinConstraints(ctx: Context, pin: EncodedPin, channel: EncodedChannel): Bool[] {
    ...
    const exclusionProps = {position: { x: pin.encoding.positionX, y: pin.encoding.positionY }, width: diameter, height: diameter}
